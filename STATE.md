...
- (09-08) Operating layer retrofitted onto this repo itself — `AGENTS.md`, `DECISIONS.md`, `STATE.md`, `docs/LEDGER.md` written but not yet committed or pushed
...
- (09-08) Decide whether `zamstars-ops` should split — it is 369 lines because it carries STRUCTURE.md, which `catchup` and `decision` never need
